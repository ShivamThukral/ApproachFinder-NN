...
if __name__=='__main__':
    net = VotingModule(1, 256).cuda()
    input_xyz = torch.rand(8,1024,3)
    input_features = torch.rand(8,256,1024)
    xyz, features = net(input_xyz.cuda(), input_features.cuda())
    print('seed_xyz',input_xyz.shape)
    print('seed_features', input_features.shape)
    print('vote_xyz', xyz.shape)
    print('vote_features', features.shape)
